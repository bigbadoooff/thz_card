        ...
        ${o?W`
          <div class="entity-section-content">
            <div class="section-actions">
              <button class="action-button" @click=${e=>{e.stopPropagation(),this._selectAllInSection(t)}}>
                Select All
              </button>
              <button class="action-button" @click=${e=>{e.stopPropagation(),this._deselectAllInSection(t)}}>
                Deselect All
              </button>
            </div>

 ...
 */class nt extends b{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,s)=>{const i=s?.renderBefore??e;let r=i._$litPart$;if(void 0===r){const t=s?.renderBefore??null;i._$litPart$=r=new Q(e.insertBefore(H(),t),t,void 0,s??{})}return r._$AI(t),r})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return G}}nt._$litElement$=!0,nt.finalized=!0,ot.litElementHydrateSupport?.({LitElement:nt});const at=ot.litElementPolyfillSupport;at?.({LitElement:nt}),(ot.litElementVersions??=[]).push("4.2.2");customElements.define("thz-card-editor",class extends nt{static get properties(){return{hass:{type:Object},config:{type:Object}}}setConfig(t){this.config=t}render(){return this.hass&&this.config?j`
    ...
    `}_getKeyTemperatureSensors(t){const e=[{pattern:/room.*temp|raum.*temp|indoor/i,found:null},{pattern:/outside.*temp|outdoor|au[sß]en.*temp|ambient/i,found:null},{pattern:/flow.*temp|vorlauf.*temp|supply/i,found:null},{pattern:/return.*temp|r[üu]cklauf.*temp/i,found:null}];t.forEach(t=>{const s=this.hass.states[t];if(!s)return;const i=(t+" "+(s.attributes.friendly_name||"")).toLowerCase();e.forEach(e=>{!e.found&&e.pattern.test(i)&&(e.found=t)})});const s=e.filter(t=>t.found).map(t=>t.found),i=t.filter(t=>!s.includes(t));return[...s,...i].slice(0,4)}_renderStatusBadge(){const t=this._findEntitiesByPattern(/state|status|mode|betrieb/i,"sensor");if(0===t.length)return j``;const e=this.hass.states[t[0]];if(!e)return j``;const s=e.state;let i="status-unknown",r="●";return/heat|heating|heizen/i.test(s)?(i="status-heating",r="🔥"):/cool|cooling|kühlen/i.test(s)?(i="status-cooling",r="❄️"):/idle|standby|bereit/i.test(s)?(i="status-idle",r="⏸️"):/defrost|abtau/i.test(s)?(i="status-defrost",r="🌨️"):/off|aus/i.test(s)&&(i="status-off",r="⭕"),j`

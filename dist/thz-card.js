 ...
 */class nt extends b{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const s=i?.renderBefore??e;let r=s._$litPart$;if(void 0===r){const t=i?.renderBefore??null;s._$litPart$=r=new Q(e.insertBefore(T(),t),t,void 0,i??{})}return r._$AI(t),r})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return W}}nt._$litElement$=!0,nt.finalized=!0,ot.litElementHydrateSupport?.({LitElement:nt});const at=ot.litElementPolyfillSupport;at?.({LitElement:nt}),(ot.litElementVersions??=[]).push("4.2.2");customElements.define("thz-card-editor",class extends nt{static get properties(){return{hass:{type:Object},config:{type:Object}}}setConfig(t){this.config=t}render(){return this.hass&&this.config?I`
    ...
    `:I``}_renderTemperatureSection(){if(!this.config.show_temperature)return"";const t=this._findEntitiesByPattern(/temperature|temp/i);return I`
      <div class="section">
    ...
    `}_renderTemperatureGraph(t){const e=t.slice(0,4);if(0===e.length)return"";this._historyData[e[0]]||this._loadHistoryData(e);const i=["#ff6b6b","#4ecdc4","#45b7d1","#f9ca24"];return I`
    ...
    `}_renderGraph(t,e){const i=10,s=40,r=100-s-10,o=200-i-20;if(!t.some(t=>this._historyData[t]&&this._historyData[t].length>0))return I`
      ...
      `;let n=1/0,a=-1/0,c=1/0,l=-1/0;if(t.forEach(t=>{(this._historyData[t]||[]).forEach(t=>{const e=parseFloat(t.state);isNaN(e)||(n=Math.min(n,e),a=Math.max(a,e));const i=new Date(t.last_changed).getTime();c=Math.min(c,i),l=Math.max(l,i)})}),!isFinite(n)||!isFinite(a))return I`
        <div class="graph-loading">
          No temperature data available
        </div>
      `;if(n===a)n-=1,a+=1;else{const t=a-n;n=Math.floor(n-.1*t),a=Math.ceil(a+.1*t)}const h=[];for(let t=0;t<=5;t++){const e=n+t/5*(a-n),i=o-t/5*o;h.push({temp:e.toFixed(1),y:i})}const d=t.map((t,i)=>{const s=this._historyData[t]||[];if(0===s.length)return null;const h=s.map(t=>{const e=parseFloat(t.state);if(isNaN(e))return null;return{x:(new Date(t.last_changed).getTime()-c)/(l-c)*r,y:o-(e-n)/(a-n)*o}}).filter(t=>null!==t);if(0===h.length)return null;const d=h.map((t,e)=>`${0===e?"M":"L"} ${t.x} ${t.y}`).join(" ");return{path:d,color:e[i]}}).filter(t=>null!==t);return I`
    ...
    `}_renderHeatingCircuitSection(){const t=this._findEntitiesByPattern(/hc1|heating.*circuit.*1|heizkreis.*1/i,"number"),e=this._findEntitiesByPattern(/hc1|heating.*circuit.*1|heizkreis.*1/i,"switch");return I`
      <div class="section">
        ...
        <div class="control-grid">
          ${e.slice(0,2).map(t=>{const e=this.hass.states[t];if(!e)return"";const i=this._getEntityName(e),s="on"===e.state;return I`
            ...
            `})}
          ${t.slice(0,3).map(t=>{const e=this.hass.states[t];if(!e)return"";const i=this._getEntityName(e),s=e.state,r=e.attributes.min||0,o=e.attributes.max||100,n=e.attributes.step||1,a=e.attributes.unit_of_measurement||"";return I`
              <div class="control-item">
                <div class="control-name">${i}</div>
    ...
    `}_renderHotWaterSection(){const t=this._findEntitiesByPattern(/dhw|hot.*water|warmwasser/i,"switch"),e=this._findEntitiesByPattern(/dhw|hot.*water|warmwasser/i,"number");return I`
      <div class="section">
        <div class="section-title">Hot Water</div>
        <div class="control-grid">
          ${t.slice(0,2).map(t=>{const e=this.hass.states[t];if(!e)return"";const i=this._getEntityName(e),s="on"===e.state;return I`
              <div class="control-item">
                <div class="control-name">${i}</div>
                <button 
                  class="switch-button ${s?"on":"off"}"
            ...
            `})}
          ${e.slice(0,2).map(t=>{const e=this.hass.states[t];if(!e)return"";const i=this._getEntityName(e),s=e.state,r=e.attributes.min||0,o=e.attributes.max||100,n=e.attributes.step||1,a=e.attributes.unit_of_measurement||"";return I`
              <div class="control-item">
                <div class="control-name">${i}</div>
                <div class="number-control">
                  <input 
    ...
    `}_renderAdditionalControls(){const t=this._findEntitiesByPattern(/cooling|emergency|party|holiday/i,"switch");return 0===t.length?"":I`
      <div class="section">
        <div class="section-title">Additional Controls</div>
        <div class="control-grid">
          ${t.slice(0,4).map(t=>{const e=this.hass.states[t];if(!e)return"";const i=this._getEntityName(e),s="on"===e.state;return I`
              <div class="control-item">
                <div class="control-name">${i}</div>
                <button 
                  class="switch-button ${s?"on":"off"}"
